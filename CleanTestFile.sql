...
/*
 Procedure Name      : sp_GetcharlieBySource
 Version             : 1.0
 Description         : This procedure gets list of charlies based on source
 Owner               : Gus Johnson
 Input               : p_source,p_from,p_to 
 Output              :  v_charlie_details
 Date                : 10/08/2008
 LastModified        : 
*/
